...
import { MENU_ITEMS, MEAL_LABELS, type MenuItem, type MealTime, type DietTag } from "@/data/menu";
    ...
    <main className="pt-28 pb-32 px-[5%] relative">
      ...
      <div className="max-w-[1200px] mx-auto mb-8 bg-yellow-50 border border-yellow-200 rounded-2xl p-4 flex items-start gap-3">
        ...
        <p className="text-xs text-yellow-900 leading-relaxed">
          <span className="font-semibold">Prices shown are estimates.</span> Final pricing is confirmed by
          the kitchen when you send your order through WhatsApp. No payment is taken on this page.
        </p>
      </div>
