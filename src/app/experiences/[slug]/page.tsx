...
// ---------------------------------------------------------------------------
// Static params — pre-render every experience page at build time
// ---------------------------------------------------------------------------
          ...
          <div className="lg:col-span-2">
            <div className="sticky top-28 bg-white border border-border rounded-2xl p-6 shadow-sm">
              ...
              <a
                ...
                className="block w-full text-center bg-accent text-white py-4 rounded-full font-medium hover:bg-accent-dark transition-all"
              >
                Book via WhatsApp
              </a>
