            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-white/25 text-white/60 transition-all hover:border-[#E1306C] hover:bg-[#E1306C] hover:text-white"
                >
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-white/25 text-white/60 transition-all hover:border-white hover:bg-black hover:text-white"
                >
                  <svg width="13" height="14" viewBox="0 0 448 512" fill="currentColor">
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-white/25 text-white/60 transition-all hover:border-[#FFFC00] hover:bg-[#FFFC00] hover:text-black"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-white/25 text-white/60 transition-all hover:border-[#25D366] hover:bg-[#25D366] hover:text-white"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
