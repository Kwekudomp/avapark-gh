      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="rounded-2xl overflow-hidden shadow-sm border border-border h-80 lg:h-full min-h-[320px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.0!2d0.1!3d6.1!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMDYnMDAuMCJOIDDCsDA2JzAwLjAiRQ!5e0!3m2!1sen!2sgh!4v1234567890!5m2!1sen!2sgh"
              width="100%"
              height="100%"
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a
                href="https://maps.google.com/?q=Okwenya,+Eastern+Region,+Ghana"
                target="_blank"
