...
import { WHATSAPP_URL, INSTAGRAM_URL, TIKTOK_URL } from "@/data/constants";
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        <a
          ...
          className="w-11 h-11 rounded-full bg-dark flex items-center justify-center shadow-md hover:scale-110 transition-transform"
        >
          <svg width="18" height="20" viewBox="0 0 448 512" fill="white">
        ...
        {/* WhatsApp (in expanded state) */}
        <a
          href={WHATSAPP_URL}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat on WhatsApp"
          className="w-11 h-11 rounded-full bg-whatsapp flex items-center justify-center shadow-md hover:scale-110 transition-transform"
        >
